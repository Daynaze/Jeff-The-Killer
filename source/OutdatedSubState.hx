...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		kadeLogo.scale.y = 0.9;
		kadeLogo.scale.x = 0.9;
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Thank you for downloading Vs. Jeff!"
			+ "\nEngine credits go to KadeDev"
			+ "\n\nThis mod is made by:\n"
			+ "\n- El Taco | Charter"
			+ "\n- Nonexistent Anomaly | Musician"
			+ "\n- Ral | Artist"
			+ "\n- Dr. Daynaze | Programmer"
		...
		new FlxTimer().start(0.8, function(tmr:FlxTimer)
		{
			...
			else FlxTween.tween(kadeLogo, {alpha: 0.3}, 0.3, {ease: FlxEase.quartInOut});
		}, 0);
	}
